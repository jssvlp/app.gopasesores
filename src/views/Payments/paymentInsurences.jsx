...
import {Button, Col, ControlLabel, FormControl, InputGroup, Modal, Row} from "react-bootstrap";
import Datetime from "react-datetime";

@inject('payments','users')
@observer
class paymentsInsurences extends Component {
    constructor(props){
        super(props)
        this.state = {
            modal:false,
    ...
    reloadTable(){
        const {payments} = this.props;
        payments.getPaymentsPendingInsurences('pendingInsurance');
    }
    ...
    async payToIsurece(){
        ...
        const result = await payments.payToIsurece(body);
        console.log(result);
            ...
            <div className={!this.state.create?"main-content":""}>
                ...
                {!this.state.create&&(
                    <Datatable
                        ...
                        tdArray={payments.getAllListPaymentInsurence}
                ...
                >
                    ...
                    <Modal.Footer>
                        <Button bsStyle="success" onClick={()=>this.payToIsurece()}>Guardar</Button>
                    </Modal.Footer>
                </Modal>
...
export default paymentsInsurences
